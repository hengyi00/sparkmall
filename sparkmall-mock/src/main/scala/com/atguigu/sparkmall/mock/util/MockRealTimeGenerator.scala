...
import com.atguigu.sparkmall.common.conf.ConfigurationUtil
...
object MockRealTimeGenerator {
    ...
    def generateMockData(): Array[String] = {
        ...
        for (_ <- 0 to new Random().nextInt(50)) {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val broker: String = ConfigUtil.getValueByKey("kafka.broker.list")
        val topic =  "ads_log"
        // 创建Kafka消费者
